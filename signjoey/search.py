...
from signjoey.EnsembleTransformer import EnsembleTransformerDecoder
...
def greedy(
    ...
    if isinstance(decoder, TransformerDecoder) or isinstance(decoder, EnsembleTransformerDecoder) :
...
def beam_search(
    ...
    # init
    transformer = isinstance(decoder, TransformerDecoder) or  isinstance(decoder, EnsembleTransformerDecoder) 
    batch_size = src_mask.size(0)
